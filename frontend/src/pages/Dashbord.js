			...
			<div className="row row--grid">
				<div className="col-12">
					<div className="main__title">
						...
						<a href="/add-item" className="main__title-link">add item</a>
					</div>
				</div>
							...
							<table className="main__table main__table--dash">
								...
								<tbody>
									<tr>
										...
										<td>
											<div className="main__table-text"><a href="#">Brian Cranston</a></div>
										</td>
										<td>
											<div className="main__table-text main__table-text--grey">bcxwz@email.com</div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div className="main__table-text"><a href="#">Jesse Plemons</a></div>
										</td>
										<td>
											<div className="main__table-text main__table-text--grey">jess@email.com</div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div className="main__table-text"><a href="#">Matt Jones</a></div>
										</td>
										<td>
											<div className="main__table-text main__table-text--grey">matt@email.com</div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div className="main__table-text"><a href="#">Tess Harper</a></div>
										</td>
										<td>
											<div className="main__table-text main__table-text--grey">harper@email.com</div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div className="main__table-text"><a href="#">Jonathan Banks</a></div>
										</td>
										<td>
											<div className="main__table-text main__table-text--grey">bank@email.com</div>
										</td>
										<td>
